...
class valorarVendedorForm extends formBase {
    ...
    protected function CreateFields($datos) {
        ...
        $html = <<<HTML
            <fieldset>
                <legend>Valorar al vendedor (ID: {$idVendedor}) con ID producto: {$idProducto}</legend>
    ...
    protected function Process($datos) {
        ...
        error_log("🚀 DEBUG Process datos: " . print_r($datos, true));
        ...
        if (empty($id_comprador) || empty($id_vendedor) || empty($id_producto) || $puntuacion === '' || empty($comentario)) {
